<template>
  <a-row :gutter="20">
    <a-col :span="12" v-if="expertInfo != null" style="margin-top: 30px">
      <a-card :bordered="false">
        ...
        <div>
          <a-avatar :src="'http://127.0.0.1:9527/imagesWeb/' + expertInfo.images" shape="square" style="width: 100px;height: 100px;float: left;margin: 10px 0 10px 10px" />
          <div style="float: left;margin-left: 20px;margin-top: 8px">
            <span style="font-size: 20px;font-family: SimHei">{{ expertInfo.name }}</span>
            <span style="font-size: 14px;font-family: SimHei">{{ expertInfo.code }}</span>
          </div>
          <div style="clear: both;margin-left: 20px;margin-top: 8px">
            <span style="font-size: 14px;font-family: SimHei">{{ expertInfo.createDate == null ? '- -' : expertInfo.createDate }}</span>
          </div>
        </div>
      </a-card>
    </a-col>
    <a-col :span="8">
      <a-card :loading="loading" :bordered="false" style="margin-top: 30px">
...
export default {
  ...
  methods: {
    ...
    setFormValues ({...expert}) {
      ...
      let fields = ['code', 'name', 'phone', 'sex', 'images', 'createDate']
      let obj = {}
